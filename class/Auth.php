...
class Auth {
	...
	public function resetPassword($db, $email) {
		...
		if ($user) {
			...
			mail(htmlspecialchars($_POST['email']), 'Réinitialisation de votre mot de passe', "Afin de réinitialisation votre mot de passe merci de cliquer sur ce lien:\n\nhttp://localhost:8080/Camagru/reset.php?id={$user->id}&token=$reset_token");
			return $user;
		}
		return false;
	}
